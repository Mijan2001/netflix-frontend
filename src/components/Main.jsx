        ...
        <div className="w-full h-[550px] text-white">
            ...
            <div className="absolute w-full top-[20%] p-4 md:p-8">
                ...
                <div className="my-4">
                    ...
                    <button class="btn py-2 border relative inline-flex items-center justify-start overflow-hidden font-medium transition-all  rounded hover:bg-gray-500 group  px-5">
                        <span class="w-56 h-48 rounded bg-gray-700 absolute bottom-0 left-0 translate-x-full ease-out duration-500 transition-all translate-y-full mb-9 ml-9 group-hover:ml-0 group-hover:mb-32 group-hover:translate-x-0"></span>
